...
var UIController = (function () {
    ...
    var formatNumber = function(num, type) {
        ...
        /* + or - before the UI element
        2 decimal points after numbers
        ...
        int = numSplit[0];
        if (int.length > 3) {
            int = int.substr(0, int.length - 3) + ',' + int.substr(int.length - 3, 3); // input = 2300; output = 2,300;
        }
    ...
    return {
        ...
        addListItem: function (obj, type) {
            // 1. Create HTML string with a placeholder
            ...
            // 2. Replace the placeholder with real data
        ...
        displayMonth: function () {
            // var now, year;
            // now = new Date();
            // var christmas = new Date(2016, 11, 25); example
            // month = now.getMonth();
            // year = now.getFullYear();
            // document.querySelector(DOMstrings.dateLabel).textContent = (month + 1) + '/' + year;
            document.querySelector(DOMstrings.dateLabel).textContent = new Date().toLocaleDateString('en-US', { month: 'long', year: 'numeric' }); // Better Solution than mine above.
        },
...
// GLOBAL APP CONTROLLER - Call methods from budget and UI controllers
var controller = (function (budgetCtrl, UICtrl) {
    ...
    // DRY principle - add a function that can be used in place of copying the same code over in different DOM functions
    ...
    // Pass the other two controllers as arguments in order to use/connect them
    // Not good practice to use the original controller names inside here, that's why we created the new ones
